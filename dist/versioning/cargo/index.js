...
exports.isValid = (input) => npm_1.api.isValid(cargo2npm(input));
const matches = (version, range) => npm_1.api.matches(version, cargo2npm(range));
const maxSatisfyingVersion = (versions, range) => npm_1.api.maxSatisfyingVersion(versions, cargo2npm(range));
