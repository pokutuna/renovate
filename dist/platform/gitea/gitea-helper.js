...
async function closePR(repoPath, idx, options) {
    await updatePR(repoPath, idx, {
        ...options,
        state: pull_requests_1.PR_STATE_CLOSED,
    });
}
